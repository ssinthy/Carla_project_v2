...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.labe_ego_position.setGeometry(QtCore.QRect(20, 80, 121, 21))
        font = QtGui.QFont()
        ...
        self.label_emv_position.setGeometry(QtCore.QRect(20, 180, 211, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.comboBox_emv_position.setGeometry(QtCore.QRect(260, 180, 181, 23))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_emv_position_2.setGeometry(QtCore.QRect(20, 130, 171, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_emv_position.setText(_translate("MainWindow", "EMV Travel Direction"))
        self.comboBox_emv_position.setItemText(0, _translate("MainWindow", "Approaches from Behind"))
        self.comboBox_emv_position.setItemText(1, _translate("MainWindow", "As Lead Vehicle"))
        self.comboBox_emv_position.setItemText(2, _translate("MainWindow", "Approaches from Right Lane"))
        self.comboBox_emv_position.setItemText(3, _translate("MainWindow", "Approaches from Left Lane"))
        self.comboBox_emv_position.setItemText(4, _translate("MainWindow", "Approaches on Opposite Lane"))
        self.comboBox_emv_position.setItemText(5, _translate("MainWindow", "Approaches Intersection"))
        self.comboBox_emv_position.setItemText(6, _translate("MainWindow", "Approaches T-Junction"))
